...
class LedgerBcoin {
  ...
  signMessage(path, message, pin) {
    return this.ledger.signMessage(path, message, pin);
  }
  ...
  signMessageLegacy(path, message, pin) {
    return this.ledger.signMessageLegacy(path, message, pin);
  }
}
