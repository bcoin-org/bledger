...
class APDUCommand {
  ...
  static getOperationMode() {
    return new APDUCommand({
      cla: apdu.CLA.CLA_GENERAL,
      ins: apdu.INS.INS_GET_OPERATION_MODE
    });
  }
  ...
  static setOperationMode(mode) {
    return new APDUCommand({
      cla: apdu.CLA.CLA_GENERAL,
      ins: apdu.INS.INS_SET_OPERATION_MODE,
...
class APDUResponse {
  ...
  static getOperationMode(data) {
    ...
    return new APDUResponse({
      status: status,
      type: apdu.INS.INS_GET_OPERATION_MODE,
  ...
  static setOperationMode(data) {
    ...
    return new APDUResponse({
      status: status,
      type: apdu.INS.INS_SET_OPERATION_MODE,
...
function getModeName(mode) {
  switch (mode) {
    case apdu.OPERATION_MODES.OPERATION_MODE_WALLET:
      return 'OPERATION_MODE_WALLET';
    case apdu.OPERATION_MODES.OPERATION_MODE_RELAXED_WALLET:
      return 'OPERATION_MODE_RELAXED_WALLET';
    case apdu.OPERATION_MODES.OPERATION_MODE_SERVER:
      return 'OPERATION_MODE_SERVER';
    case apdu.OPERATION_MODES.OPERATION_MODE_DEVELOPER:
